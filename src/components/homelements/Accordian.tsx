...
const Accordion = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white px-10 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
    ...
    <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-dark-2 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8">
      ...
      >
        ...
        <div className="w-full">
          <h4 className="mt-1 text-lg font-semibold text-dark dark:text-black font-poppins">
            {header}
          </h4>
        </div>
      </button>
      ...
      >
        <p className="py-3 text-base leading-relaxed text-body-color dark:text-black font-poppins">
          {text}
        </p>
      </div>
    </div>
